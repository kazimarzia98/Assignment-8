                ...
                <div className="blog-container my-5 mx-2 lg:ms-20 ">
                    ...
                    <div className="blog-detail flex justify-between my-5 ">
                        ...
                        <div className="blog-readingTime flex text-slate-600">
                             {blog.time} min read
                            <svg onClick={()=> handleBookmark(blog.title)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer hover:text-blue-500">
